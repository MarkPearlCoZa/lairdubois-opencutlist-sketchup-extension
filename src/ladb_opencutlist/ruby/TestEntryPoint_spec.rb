    ...
    describe BinPacking2D do
      context "When testing the BinPacking Engine bbox optimisation" do
        ...
        it "should not be able to make a placement" do
          ...
          expect(result[0].original_bins[0].width).to eq 1000
          ...
          expect(result[0].original_bins[0].boxes[0].length).to eq 500
          expect(result[0].original_bins[0].boxes[0].width).to eq 500
          expect(result[0].original_bins[0].boxes[0].x).to eq 0
          expect(result[0].original_bins[0].boxes[0].y).to eq 0
          ...
          expect(result[0].original_bins[0].cuts.length).to eq 4
          expect(result[0].original_bins[0].cuts[0].x).to eq 0
          expect(result[0].original_bins[0].cuts[0].y).to eq 500
          expect(result[0].original_bins[0].cuts[0].length).to eq 500
          ...
          expect(result[0].original_bins[0].cuts[1].x).to eq 500
          expect(result[0].original_bins[0].cuts[1].y).to eq 0
          ...
          expect(result[0].original_bins[0].cuts[2].x).to eq 0
          expect(result[0].original_bins[0].cuts[2].y).to eq 500
          expect(result[0].original_bins[0].cuts[2].length).to eq 2000
          expect(result[0].original_bins[0].cuts[2].is_primary).to eq true
          expect(result[0].original_bins[0].cuts[2].is_horizontal).to eq true

          expect(result[0].original_bins[0].total_length_cuts).to eq 3500
          expect(result[0].original_bins[0].efficiency).to eq 12.5

          expect(result[0].original_bins[0].leftovers).kind_of?(Array)
          expect(result[0].original_bins[0].leftovers.length).to eq 2
          expect(result[0].original_bins[0].leftovers[0].length).to eq 2000
          expect(result[0].original_bins[0].leftovers[0].width).to eq 499
          expect(result[0].original_bins[0].leftovers[0].type).to eq 0
          expect(result[0].original_bins[0].leftovers[0].x).to eq 0
          expect(result[0].original_bins[0].leftovers[0].y).to eq 501
          ...
          expect(result[0].original_bins[0].leftovers[0].trimsize).to eq 0
          ...
          expect(result[0].original_bins[0].leftovers[1].length).to eq 1499
          expect(result[0].original_bins[0].leftovers[1].width).to eq 500
          expect(result[0].original_bins[0].leftovers[1].type).to eq 0
          expect(result[0].original_bins[0].leftovers[1].x).to eq 501
          expect(result[0].original_bins[0].leftovers[1].y).to eq 0
          ...
          expect(result[0].original_bins[0].leftovers[1].trimsize).to eq 0
          ...
          expect(result[0].original_bins[0].trimsize).to eq 0
          ...
          expect(result[0].performance.largest_leftover_length).to eq 2000
          expect(result[0].performance.largest_leftover_width).to eq 499
      ...
      context "When testing the BinPacking Engine bbox optimisation" do
        ...
        it "should return a double placement if there are two box that can fit" do
          ...
          expect(result[0].original_bins[0].cuts).kind_of?(Array)
          expect(result[0].original_bins[0].cuts.length).to eq 5
          expect(result[0].original_bins[0].cuts[0].x).to eq 402
          expect(result[0].original_bins[0].cuts[0].y).to eq 1
          expect(result[0].original_bins[0].cuts[0].length).to eq 300
          expect(result[0].original_bins[0].cuts[0].is_primary).to eq true
          expect(result[0].original_bins[0].cuts[0].is_horizontal).to eq false

          expect(result[0].original_bins[0].cuts[1].x).to eq 1
          expect(result[0].original_bins[0].cuts[1].y).to eq 301
          expect(result[0].original_bins[0].cuts[1].length).to eq 401
          expect(result[0].original_bins[0].cuts[1].is_primary).to eq true
          expect(result[0].original_bins[0].cuts[1].is_horizontal).to eq true
          ...
          expect(result[0].original_bins[0].total_length_cuts).to eq 3299
